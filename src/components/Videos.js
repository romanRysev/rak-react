  ...
  return (
    <section className="videos container">
      <div className="videos__container">
        ...
        <div className="videos__player-container">
          <iframe
            className="videos__iframe"
            src="https://www.youtube.com/embed/coOppM34GtI?enablejsapi=1"
            title="video"
          ></iframe>
          <a href="https://www.youtube.com/results?search_query=%23%D1%8D%D1%82%D0%BE%D0%BD%D0%B5%D0%BB%D0%B5%D1%87%D0%B8%D1%82%D1%81%D1%8F">
      ...
      <div className="videos__footer">
        <p className="videos__footer-text">
          И В ОТЛИЧИЕ ОТ РАКА, #ЭТОНЕЛЕЧИТСЯ
        </p>
      </div>
    </section>
  );
